  ...
  return (
    <div>
      <svg height={HEIGHT} width={WIDTH}>
        <path d={describeArc(WIDTH/2, HEIGHT/2, ARC_RADIUS, angle1, angle2, largeArc)} fill="none" strokeWidth="2" stroke={ARC_COLOUR}></path>
        ...
        <circle cx={WIDTH/2} cy={HEIGHT/2} r={3} fill="black" stroke="white" />
      </svg>
    </div>
  )
}